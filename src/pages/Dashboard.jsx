      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {data.map((item, index) => (
          <div key={index} className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
            ...
            <div className="text-xl font-bold text-blue-600">₹{item.revenue?.toLocaleString() || 0}</div>
              ...
              {loadingSummary ? (
                ...
                quickStats.map((stat, index) => (
                  <Col xs={12} sm={6} key={index}>
                    <Link to={stat.linkTo} className="block p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg hover:from-blue-50 hover:to-blue-100 transition-all duration-200 border border-gray-200 hover:border-blue-200 hover:shadow-md">
                      <div className="text-center">
